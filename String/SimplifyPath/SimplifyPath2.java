...
public class SimplifyPath2 {
    ...
    public static void main(String args[]){
        ...
        System.out.println((new SimplifyPath2()).simplifyPath(path1));
		System.out.println((new SimplifyPath2()).simplifyPath(path2));
		System.out.println((new SimplifyPath2()).simplifyPath(path3));
		System.out.println((new SimplifyPath2()).simplifyPath(path4));
    }
}
/*
